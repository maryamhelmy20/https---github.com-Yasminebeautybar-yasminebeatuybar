...
class HomeController extends Controller
{
   ...
   $point =$product_stock->earn_point;
        ...
        if ($product->stock_visibility_state == 'text') {
            if ($product->low_stock_quantity  < $quantity && $product->min_qty < $quantity) {
                $quantity = translate('In Stock');
            }
            
            elseif( $product->low_stock_quantity >= $quantity && $quantity != 0)
            {

                $quantity= "<span class='badge badge-inline badge-danger'>Low Stock</span>
                <style>
                   .low-stock{color:red;}
               </style>";
        ...
        if ($product->stock_visibility_state == 'quantity') {
            if (  $product->low_stock_quantity  < $quantity) {
                $quantity = '('. $quantity." ". translate('available').')';
            } 
            elseif( $product->low_stock_quantity >= $quantity && $quantity != 0)
            {

                $quantity='('. $quantity." ". translate('available').')' ."  "."<span class='badge badge-inline badge-danger'>Low Stock</span>
                <style>
                   .low-stock{color:red;}
               </style>";
         ...
         elseif ($product->stock_visibility_state == 'textqty') {
            if ($product->low_stock_quantity  < $quantity && $product->min_qty < $quantity) {
                $quantity = translate('In Stock');
            }
            ...
            elseif( $product->low_stock_quantity >= $quantity && $quantity != 0)
            {
                ...
                $quantity= $quantity = '('. $quantity." ". translate('available').')'." ".
                "<span class='badge badge-inline badge-danger'>Low Stock</span>
                <style>
                   .low-stock{color:red;}
               </style>";
