                                ...
                                <div class="row no-gutters mt-4">
                                    ...
                                    <div class="col-sm-10">
                                        <div
                                            ...
                                            <span class="strong-700">                           @php 
                                                $a=0;
                                                
                                                foreach ($detailedProduct->stocks as $key => $stock)
                                                {
                                                    if( $stock->earn_point!=null )
                                                    {
                                                    if($a <= $stock->earn_point){
                                                echo'<span id="available-point" > </span>';         
                                                         }
                                                      }
                                                    else 
                                                    {
                                                        $a=$detailedProduct->earn_point;
                                                        echo $a;
                                                    ...
                                                    <div class="media-body text-left">
                                                        ...
                                                        <p class="comment-text">
                                                            {{ $review->comment }}
                                                              ...
                                                              <div>
                                                            <img src={{ uploaded_asset($review->image) }} alt="Image" class="size-150px img-fit">
