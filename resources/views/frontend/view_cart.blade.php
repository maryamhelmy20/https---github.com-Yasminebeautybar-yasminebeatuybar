            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center mb-3">
                        <p class="text-muted mb-2">{{ translate('Dont have an account?') }}</p>
                         <a href="{{ route('user.registration') }}" >  <button class="col-11" style="
    padding: 0.6rem 1.2rem;
    font-size: 0.9rem;
 cursor:pointer; color:#cc0d66;margin: auto;border:1px solid #cc0d66;text-align:center;background:transparent ;"> {{ translate('Register Now') }}</button> </a>
                    </div>
